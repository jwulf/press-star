            ...
            */
            ...
            var applyPatch = function (topicID, newHtml, revision, cb) {
                ...
                topicInstances.each(function() {
                    ...
                    // Is that right though? Isn't there some time between the initialization of the build
                    // and the rewriting of the topic revisions? Anything in that gap will be lost.
                    // my.topicRevisions[topicID] = revision;

                    // Call back out of this patch when we're finished
                    count ++;
