...
function Book(shadow) {
    ...
    this.set('serverurl', '', EMIT_EVENTS);
    ...
    this.set('builtFilename', '', EMIT_EVENTS);
    this.set('hostedURL', '', EMIT_EVENTS);
    this.set('buildingForReals', true);
    this.set('edition', '');
    this.set('pubsnumber', '');
    this.set('dtd', '');
    this.set('copyright', '');
