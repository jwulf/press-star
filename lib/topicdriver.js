...
function topicupdate (req, res) {
    ...
    var url, xml, log_level, log_msg, userid, id, _req;
    ...
    if (id && url && xml) {
        adjustProgramlistingLanguages(xml, function(err, result) {
            ...
            updateTopicInPressGang(userid, url, id, xml, log_level, log_msg, function (result) {
...
function updateTopicInPressGang (userid, url, id, xml, log_level, log_msg, cb) {
    var _cb, _log_level, _log_msg, _url,
        DEFAULT_LOG_MSG = 'Updated from the Death Star editor';
