...
function initialize () {
    exports.NotificationStream =  new Stream ();
    exports.NotificationStream.writable = exports.NotificationStream.readable = true;
    exports.NotificationStream.write = notificationStreamWrite;
    exports.NotificationStream.setMaxListeners(50); // allow up to 50 listeners to the index page
...
function notifyBooks (data) {
    exports.NotificationStream.write({'change': data});    
}
